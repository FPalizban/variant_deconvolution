#!/usr/bin/env python3
"""
Train multitask deconvolution model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train weakly supervised multitask model for origin, role, event, and confidence outputs.")
